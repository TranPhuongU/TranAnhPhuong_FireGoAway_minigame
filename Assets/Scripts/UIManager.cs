...
public class UIManager : MonoBehaviour
{
    ...
    // ⭐ STAR UI
    [Header("Stars")]
    [SerializeField] TMP_Text starTotalText;      // in-game
    [SerializeField] TMP_Text starTotalTextWin;   // win panel
    [SerializeField] TMP_Text starTotalTextLose;  // lose panel
    [SerializeField] TMP_Text starWinText;        // +5
    [SerializeField] TMP_Text starLoseText;       // +0
